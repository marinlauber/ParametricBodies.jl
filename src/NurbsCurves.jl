...
- `knots`: A 1D array of the knot vector of the NURBS curve
- `wgts`: A 1D array of the weight of the control points of the NURBS curve 
- `d`: The degree of the NURBS curve
- `n`: the spatial dimension of the NURBS curve, n ∈ {2,3}
"""
